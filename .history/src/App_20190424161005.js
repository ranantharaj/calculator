  ...
  render() {
    return (
      ...
      <div className="App text-center">
        ...
        <table>
          <tr>
            <td className="btn" onClick={(e) => this.setState({ val2: 7, result: this.state.result + '7' })}> 7 </td>
          ...
          <tr>
            <td onClick={(e) => this.setState({ val2: 4, result: 4 })}> 4 </td>
            <td onClick={(e) => this.setState({ val2: 5, result: 5 })}> 5 </td>
            <td onClick={(e) => this.setState({ val2: 6, result: 6 })}> 6 </td>
            <td onClick={(e) => this.calculation('-')}> - </td>
          </tr>
          <tr>
            <td onClick={(e) => this.setState({ val2: 1 })}> 1 </td>
            <td onClick={(e) => this.setState({ val2: 2 })}> 2 </td>
            <td onClick={(e) => this.setState({ val2: 3 })}> 3 </td>
            <td onClick={(e) => this.calculation('+')}> + </td>
          </tr>
          <tr>
            <td onClick={(e) => this.calculation('CE')}> CE </td>
            <td onClick={(e) => this.setState({ val2: 0 })}> 0 </td>
            <td onClick={(e) => this.calculation('/')}> / </td>
            <td onClick={(e) => this.calculation('=')}> = </td>
          </tr>
